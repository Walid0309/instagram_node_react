...
function CreatePost() {
	...
	return (
		<div>
			<Navbar />
			{title}
			<input type="text" placeholder="title" onChange={(e) => handleForm(e.target.value, 'title')} />
			<br />
			<input type="text" placeholder="body" onChange={(e) => handleForm(e.target.value, 'body')} />
			<br />
